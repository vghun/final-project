  ...
  return (
    ...
    >
      ...
      <section className="about-intro">
        <h2>Giới Thiệu</h2>
        <p>
          BarberShop được thành lập năm 2015, chuyên cung cấp dịch vụ cắt tóc, tạo kiểu và chăm sóc tóc cho mọi đối tượng. Chúng tôi tự hào về đội ngũ thợ lành nghề, sáng tạo và tận tâm với khách hàng.
        </p>
      </section>
