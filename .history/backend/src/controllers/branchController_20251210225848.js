...
export const setSuspendDateController = async (req, res) => {
  try {
    const result = await setSuspendDate({
      branchId: req.params.id,     // <-- id FE gửi map sang branchId
      suspendDate: req.body.suspendDate,
    });
