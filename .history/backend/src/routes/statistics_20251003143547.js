...
// GET /statistics/branches?month=..&year=..
router.get("/branches", statisticsController.getBranchRevenue);

// Tổng doanh thu từng tháng của các chi nhánh trong năm
// GET /statistics/branches/monthly?year=..
router.get("/branches/monthly", statisticsController.getMonthlyBranchRevenue);
