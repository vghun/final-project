...
// Fake data mức độ hài lòng theo chi nhánh
      ...
      <div className={cx("chartBox")}>
        ...
        <div className={cx("filterBox")}>
          <select
            ...
            onChange={(e) => setFilterLuong({ ...filterLuong, year: e.target.value })}
          >
          ...
          <select
            ...
            onChange={(e) => setFilterLuong({ ...filterLuong, month: e.target.value })}
          >
          ...
          <button onClick={() => console.log("Load dữ liệu với:", filterLuong)}>
            Xem
          </button>
