...
const dataChiNhanh = [
  ...
  // Những tháng còn lại sẽ tự động fill = 0
];
...
function ThongKe() {
  ...
  // Data satisfaction theo chi nhánh
    ...
    <div className={cx("thongke")}>
      ...
      <div className={cx("chartBox")}>
        ...
        <div className={cx("filterBox")}>
          ...
          <button
            onClick={() =>
              console.log("Load dữ liệu:", filterLuong, branch)
            }
          >
            Xem
          </button>
      ...
      <div className={cx("chartBox")}>
        ...
        <div className={cx("filterBox")}>
          ...
          <button
            onClick={() =>
              exportToExcel(getFullYearData(dataChiNhanh), "DoanhThuChiNhanh", "ChiNhanh")
            }
          >
            Xuất Excel
          </button>
