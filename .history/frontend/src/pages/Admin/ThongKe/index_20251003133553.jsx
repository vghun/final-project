...
function ThongKe() {
  ...
  // AI summaries
  const [aiSummaryLuong, setAiSummaryLuong] = useState("...");
  const [aiSummaryChiNhanh, setAiSummaryChiNhanh] = useState("...");
  const [aiSummarySatisfaction, setAiSummarySatisfaction] = useState("...");
    ...
    <div className={cx("thongke")}>
      ...
      <div className={cx("chartBox")}>
        ...
        <div className={cx("filterBox")}>
          ...
          <button onClick={() => console.log("Load dữ liệu:", filterLuong, branch)}>Xem</button>
          <button onClick={() => exportToExcel(dataLuong, "DoanhThuTheoTho", "Luong")}>Xuất Excel</button>
        </div>
      ...
      <div className={cx("chartBox")}>
        ...
        <div className={cx("filterBox")}>
          ...
          <button onClick={() => exportToExcel(getFullYearData(dataChiNhanh), "DoanhThuChiNhanh", "ChiNhanh")}>
            Xuất Excel
          </button>
        </div>
      ...
      <div className={cx("chartBox")}>
        ...
        <div className={cx("filterBox")}>
          ...
          <button onClick={() => exportToExcel(satisfaction, `Hailong_${branch}`, "Hailong")}>
            Xuất Excel
          </button>
        </div>
