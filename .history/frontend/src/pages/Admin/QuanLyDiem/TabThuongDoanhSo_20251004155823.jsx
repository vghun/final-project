...
export default function TabThuongDoanhSo() {
  ...
  const handleSaveRule = async (ruleData) => {
    try {
      ...
      const payload = {
        ...ruleData,
        minRevenue: Number(ruleData.minRevenue.toString().replace(/\./g, "")),
        maxRevenue: Number(ruleData.maxRevenue.toString().replace(/\./g, "")),
        bonusPercent: Number(ruleData.bonusPercent),
      };
