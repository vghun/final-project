...
import CreateBonusModal from "~/components/CreateBonusModal"; // ✅ Modal mới
import classNames from "classnames/bind";
import styles from "./QuanLyDiem.module.scss";
import { LoyaltyRuleAPI } from "~/apis/loyaltyRuleAPI";
import { BonusRuleAPI } from "~/apis/bonusRuleAPI"; // ✅ API mới

const cx = classNames.bind(styles);

function QuanLyDiem() {
  const [rules, setRules] = useState([]);
  const [bonusRules, setBonusRules] = useState([]); // ✅ Thưởng doanh số
