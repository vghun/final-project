...
const ReelPlayer = forwardRef(
  ({ reel, idUser, onLike, onComment, onNavUp, onNavDown }, ref) => {
    ...
    const [fade, setFade] = useState(true); // fade in/out
    ...
    // Scroll chỉ khi hover vào container
    useEffect(() => {
    ...
    return (
      <div className={styles.reelItemContainer} ref={ref}>
        <div
          ref={containerRef}
          className={`${styles.videoWrapper} ${fade ? styles.fadeIn : styles.fadeOut}`}
