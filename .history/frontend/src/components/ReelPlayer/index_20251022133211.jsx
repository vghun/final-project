...
const ReelPlayer = forwardRef(
  ({ reel, idUser, onLike, onComment, onNavUp, onNavDown }, ref) => {
    ...
    useEffect(() => {
      // *** SỬA LỖI: Sử dụng 'internalRef' thay vì 'ref' ***
      // 'internalRef' được đảm bảo là một object ref.
      const container = internalRef.current; 
      if (!container) return; // Vẫn giữ kiểm tra 'current'
      ...
      // *** SỬA LỖI: Xoá 'ref' khỏi dependency array ***
      // useEffect này chỉ phụ thuộc vào các hàm callback, không phụ thuộc 'ref'
    }, [onNavUp, onNavDown]); 
