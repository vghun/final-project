...
const handleSubmit = async () => {
  try {
    ...
    formData.append("status", "Active"); // mở lại dịch vụ
    ...
    setToast({
      type: "success",
      text: res.data?.message || "Đã cập nhật dịch vụ!",
      duration: 3000,
    });
    setTimeout(() => {
    onUpdated();
    ...
    setToast({
      type: "error",
      text: error.response?.data?.error || "Không thể cập nhật!",
      duration: 3000,
    });
  }
};
